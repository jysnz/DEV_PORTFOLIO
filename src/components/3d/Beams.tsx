...
const CanvasWrapper = ({ children, transparent }: { children: React.ReactNode; transparent?: boolean }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="beams-container" gl={{ alpha: !!transparent }}>
    {children}
  </Canvas>
);
  ...
  return (
    <div className={wrapperClassName}>
      <CanvasWrapper transparent={transparent}>
        ...
        {!transparent && <color attach="background" args={["#0a0118"]} />}
